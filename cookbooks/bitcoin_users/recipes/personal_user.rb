...
cookbook_file File.join(user_home_dir, '.bash_profile') do
  source '.bash_profile_personal'

  mode '0644'
end

cookbook_file File.join(user_home_dir, '.bash_logout') do
  source '.bash_logout_personal'
...
include_recipe 'bitcoin_users::personal_user_mount'
include_recipe 'bitcoin_users::personal_user_workspace'
